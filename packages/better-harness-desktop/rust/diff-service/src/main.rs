//! Newline-delimited JSON driver for the structural-diff host.

use std::io::{self, BufRead, Write};
use std::process::ExitCode;

use harness_diff_service::handle_line;
use harness_diff_service::wire::{parse_request_frame, MAX_REQUEST_BYTES};

//! Newline-delimited JSON driver for the architecture host.

use std::io::{self, BufRead, Write};
use std::process::ExitCode;

use harness_arch_service::handle_line;
use harness_arch_service::wire::{parse_request_frame, MAX_REQUEST_BYTES};

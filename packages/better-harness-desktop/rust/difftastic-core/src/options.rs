...
pub(crate) const USAGE: &str = concat!(env!("CARGO_PKG_NAME"), " [OPTIONS] OLD-PATH NEW-PATH");
...
$ ", env!("CARGO_PKG_NAME"), " --override='*.c:C++' old.c new.c
...
$ ", env!("CARGO_PKG_NAME"), " --override='CustomFile:json' --override='*.c:text' old.c new.c
...
$ ", env!("CARGO_PKG_NAME"), " --override-binary='*.gz' old.gz new.gz

This argument may be given more than once. For example:

$ ", env!("CARGO_PKG_NAME"), " --override-binary='*.gz' --override-binary='foo.pickle' old.gz new.gz

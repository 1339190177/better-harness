...
pub(crate) struct TreeSitterConfig {
    ...
    /// as a change, and reformatting doesn't change diff results.
    ///
...
// The four grammars upstream vendors as C sources (Janet, Kotlin, LaTeX, Smali)
// are excluded from this build, so no external parser symbols are linked here.
        ...
        Python => {
            ...
            TreeSitterConfig {
                ...
                ignore_trailing_tokens: vec![
                    ...
                    ("list", ","),
                    ("set", ","),
                    // Deliberately not considering tuple, to avoid
                    // treating (1) and (1,) as equivalent.
                    ("argument_list", ","),
                    ("parameters", ","),
                ],

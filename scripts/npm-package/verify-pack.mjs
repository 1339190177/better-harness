...
const required = [
  ...
  "package/.dsh-plugin/cordis.patch.yml",
  "package/scripts/dsh-skill-discovery/bundle.mjs",
  "package/scripts/dsh-skill-discovery/provider.mjs",
  "package/scripts/dsh-skill-discovery/index.mjs",
